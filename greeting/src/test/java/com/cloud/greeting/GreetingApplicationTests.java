...
public class GreetingApplicationTests {
	...
	public void contextLoads() {
		String deGreeting = rest.getForObject("/de", String.class);
		String enGreeting = rest.getForObject("/en", String.class);
		String esGreeting = rest.getForObject("/es", String.class);
		String defaultGreeting = rest.getForObject("/", String.class);
